...
INSERT INTO `tbl_map` VALUES (1,'TEST','Test of Sys','This is just a test map',1,33),(2,'test','test title','desc test',1,NULL),(3,'nametest','titletest','desctest',1,NULL),(4,'n','t','d',1,32),(5,'n2','t2','d2',1,NULL),(6,'n2','t2','d2',1,NULL),(7,'n3','t3','d3',1,NULL),(8,'n4','t4','d4',1,NULL),(9,'aaa','bbb','ccc',1,NULL),(10,'faf','fagg','gee',1,NULL),(11,'fea','hgg','aaa',1,30),(12,'BMWn','BMWt','BMWD',1,31),(13,'TESTSunday','This is a Sunday test','nothing to write',1,NULL);
